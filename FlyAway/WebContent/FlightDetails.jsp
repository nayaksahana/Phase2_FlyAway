...
for(Flights flight:flights){
	...
	if(flightId==flight.getFlightId()){
		out.print("<thbody>");
		out.print("<tr>");
		out.print("<td><input type = 'text' name ='flight_id' size = '5' readonly value = '" +  flight.getFlightId() + "'/></td>");
		out.print("<td><input type = 'text' name ='class' size = '5' readonly value = '" +  flight.getBusiness()+ "'/></td>");
		out.print("<td><input type = 'text' name ='class' size = '5' readonly value = '" +  flight.getEconomy()+ "'/></td>");
		out.print("<td><input type = 'text' name ='class' size = '5' readonly value = '" +  flight.getFirst()+ "'/></td>");
		out.print("<td><input type = 'text' name ='class' size = '5' readonly value = '" +  flight.getFirst()+ "'/></td>");
	} 
